...
const CZ_FLAG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600"><rect width="900" height="300" fill="%23D7141A"/><rect y="300" width="900" height="300" fill="%23FFFFFF"/><polygon points="0,0 450,300 0,600" fill="%2311457E"/></svg>`;
